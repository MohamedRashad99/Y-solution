...
class DropDownSixReservation extends StatefulWidget {
  final String? initial;
  final ValueChanged<String> onChanged;
  const DropDownSixReservation({Key? key, required this.onChanged, this.initial})
      : super(key: key);

  @override
  State<DropDownSixReservation> createState() => _DropDownSixReservationState();
}

class _DropDownSixReservationState extends State<DropDownSixReservation> {
  TypeSex? selected;
