...
class DropDownIsRead extends StatefulWidget {
  ...
  const DropDownIsRead({Key? key, required this.onChanged, this.initial})
      : super(key: key);

  @override
  State<DropDownIsRead> createState() => _DropDownIsReadState();
}

class _DropDownIsReadState extends State<DropDownIsRead> {
  TypeRead? selected;
