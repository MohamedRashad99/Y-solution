...
class _AllSpecialistsFirstSessionsState
    extends State<AllSpecialistsFirstSessions> {
  @override
            ...
            children: [
              ...
              BlocConsumer<AllSpecialistFirstSessionsCubit,
                ...
                builder: (context, state) {
                  final cubit =
                      BlocProvider.of<AllSpecialistFirstSessionsCubit>(context);
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          MediaButton(
                                            onPressed: () {
                                              cubit
                                                  .firstSessionsCreateReservation(
                                                      specialistId: state
                                                          .allSpecialistModel
                                                          .data[index]
                                                          .id);
